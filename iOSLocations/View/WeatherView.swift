...
class WeatherView: UIViewController, CLLocationManagerDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        if newLocation == true{
            ...
            jsonURLString = "https://api.darksky.net/forecast/86f373a5742ca2ac810248dde73f9009/\(locValue.latitude),\(locValue.longitude)"
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if savedToCoreData == true {  self.indicator.stopAnimating()  }
        else {  self.indicator.startAnimating()  }
         ...
         URLSession.shared.dataTask(with: url) { (data, response, err) in
             ...
             do {
                 ...
                 DispatchQueue.main.async {
                    ...
                    if savedToCoreData == false && locationString != "Please wait..." && self.cleanEntity(location: locationString) == true{
